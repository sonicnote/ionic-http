...
var HomePage = (function () {
    function HomePage(navCtrl, http) {
        ...
        this.http = http;
        this.userUrl = 'https://api.fitbit.com/1/user/-/profile.json';
        this.heartUrl = 'https://api.fitbit.com/1/user/-/activities/heart/date/today/1d.json';
        ...
        http
            ...
            console.log(data);
            _this.userdata = data;
            _this.name = data.user.fullName;
            _this.age = data.user.age;
        });
        var now = new Date();
        var yesterday = new Date(now.getFullYear(), now.getMonth(), now.getDate() - 1);
        var yd = yesterday.getFullYear().toString() + '-' + yesterday.getMonth().toString() + '-' + yesterday.getDate().toString();
        console.log(yd);
        // 昨日の情報
        http
        ...
        http
            ...
            .map(function (res) { return res.json(); }).subscribe(function (data) {
            console.log(data);
            _this.todayData = data;
        });
    }
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/Takayuki/Desktop/git/ionic2-http/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Home Page</ion-title>\n  </ion-navbar>\n</ion-header>\n \n<ion-content>\n    <p>My Name: {{name}}</p>\n    <p>My Age: {{age}}</p>\n    <p>My Heart: {{heart}}</p>\n    \n</ion-content>'/*ion-inline-end:"/Users/Takayuki/Desktop/git/ionic2-http/src/pages/home/home.html"*/
        }),
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/Takayuki/Desktop/git/ionic2-http/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/Takayuki/Desktop/git/ionic2-http/src/app/app.html"*/
        }),
